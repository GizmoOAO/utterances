...
export class ConfigurationComponent {
  ...
  constructor() {
    ...
    this.element.innerHTML = `
      ...
      <ol>
        ...
        <li>Make sure the <a href="https://github.com/apps/lumina-moe-utterances-app">utterances app</a>
      ...
      <select id="theme" class="form-select" value="github-light" aria-label="Theme">
        ...
        <option value="lumina-moe">Lumina Moe</option>
      </select>
  ...
  private makeConfigScript(attrs: string) {
    // tslint:disable-next-line:max-line-length
    return `<pre><span class="pl-s1">&lt;<span class="pl-ent">script</span> <span class="pl-e">src</span>=<span class="pl-s"><span class="pl-pds">"</span>https://utterances.liuli.lol/client.js<span class="pl-pds">"</span></span></span>\n${attrs}\n<span class="pl-s1">        <span class="pl-e">async</span>&gt;</span>\n<span class="pl-s1">&lt;/<span class="pl-ent">script</span>&gt;</span></pre>`;
  }
